...
PATH_TO_JSON = "/media/wing/MyPassport/Kaggle/TrulyNative/output"
PATH_TO_TRAIN_LABELS = "/media/wing/MyPassport/Kaggle/TrulyNative/train.csv"
PATH_TO_TEST_LABELS = "/media/wing/MyPassport/Kaggle/TrulyNative/sampleSubmission.csv"
